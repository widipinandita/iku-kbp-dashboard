...
const KPI_DEFS = [
  ...
  { id:'g', label:'g. Strategi Penanganan Sengketa Pajak', formula:'60%×(SPS Tepat Waktu/SPS Diselesaikan) + 40%×(Resume Tepat Waktu/Resume Diselesaikan)', targets:{Q1:85,Q2:85,Q3:85,Q4:85}, bySeksi:true,
    fields:(q,s)=>[{key:`g_stw_${q}_${s}`,label:'SPS Tepat Waktu'},{key:`g_sd_${q}_${s}`,label:'SPS Diselesaikan'},{key:`g_rtw_${q}_${s}`,label:'Resume Tepat Waktu'},{key:`g_rd_${q}_${s}`,label:'Resume Diselesaikan'}],
